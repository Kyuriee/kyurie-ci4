...
use App\Services\Presentation\AdminContextBuilder;
...
class Services extends BaseService
{
    ...
    public static function adminContextBuilder(bool $getShared = true): AdminContextBuilder
    {
        if ($getShared) {
            return static::getSharedInstance('adminContextBuilder');
        }

        return new AdminContextBuilder();
    }
