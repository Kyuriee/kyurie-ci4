<?php
/**
 * Halaman error umum yang tampil ke user pas ENVIRONMENT = production
 * (exception selain 404). Sengaja gak nampilin detail teknis apapun ke user.
 *
 * PENTING: dirender langsung sama Exception Handler, bukan lewat
 * BaseController — helper 'url' & 'vite' di-load manual.
 */
helper(['url', 'vite']);
?>
<!DOCTYPE html>
        ...
        <div class="w-full max-w-lg text-center">
            ...
            <div class="relative overflow-hidden rounded-3xl bg-premium-panel p-10 shadow-card sm:p-12">
                ...
                <div class="relative z-10">
                    ...
                    <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-white/10 text-3xl text-secondary">
                        <i class="bi bi-exclamation-triangle-fill"></i>
                    </div>

                    <h1 class="mt-5 font-display text-xl font-bold text-white sm:text-2xl">
                        Ada yang Salah di Server Kami
                    </h1>

                    <p class="mx-auto mt-3 max-w-sm text-sm text-slate-400">
                        Tim kami udah otomatis dapat notifikasi soal ini. Coba muat ulang halaman,
                        atau balik lagi beberapa saat lagi.
                    </p>
