                ...
                <div>
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Panel ini khusus untuk staf internal Kyurie.
                        </p>
                    </div>

                    <?php if (! empty($alert)): ?>
                        <div class="mb-5 rounded-lg border px-4 py-3 text-sm <?= $alert['type'] === 'error' ? 'border-error-200 bg-error-50 text-error-700 dark:border-error-500/30 dark:bg-error-500/15 dark:text-error-400' : 'border-success-200 bg-success-50 text-success-700 dark:border-success-500/30 dark:bg-success-500/15 dark:text-success-400' ?>">
                            <?= esc($alert['message']) ?>
                        </div>
                    <?php endif; ?>
        ...
        <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
            <div class="flex items-center justify-center z-1">
                <div class="flex flex-col items-center max-w-xs">
                    <span class="mb-4 text-2xl font-bold text-white">Kyurie</span>
                    <p class="text-center text-gray-400 dark:text-white/60">
                        Panel administrasi internal — kelola game, produk, kupon, dan transaksi.
                    </p>
                </div>
            </div>
        </div>
